    ...
    <>
      ...
      {historical.length === 0 ? (
        ...
        <div className="mt-8 relative">
          ...
          <div className="overflow-x-auto rounded-xl border border-purple-500/30 scrollbar-thin scrollbar-thumb-purple-500/50 scrollbar-track-transparent" style={{ minHeight: '650px' }}>
